...
export default function AboutPage() {
  return (
    <section className="mx-auto max-w-content px-6 py-16 sm:py-20">
      ...
      <div className="mt-10 max-w-2xl space-y-5 text-lg leading-relaxed text-slate">
        <p>
      ...
      <div className="mt-14 grid gap-6 border-t border-line pt-10 sm:grid-cols-3">
        <div>
          ...
          <p className="mt-2 text-base leading-relaxed text-slate">高彈性、高 CP 值的導入模式，不綁死既有資源配置。</p>
        </div>
        <div>
          <p className="font-mono text-sm text-signal">自動化</p>
          <p className="mt-2 text-base leading-relaxed text-slate">AI 分擔人工審核負擔，聚焦真正需要人判斷的威脅。</p>
        </div>
        <div>
          <p className="font-mono text-sm text-signal">可追溯</p>
          <p className="mt-2 text-base leading-relaxed text-slate">每一起事件都有編號、時間軸與處置紀錄，全程可覆盤。</p>
        </div>
      </div>
    </section>
  );
