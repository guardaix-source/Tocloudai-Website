          ...
          <div className="mt-10 grid gap-5 sm:grid-cols-2">
            {PILLARS.map((p) => (
              <div key={p.n} className="glow-card rounded-lg bg-surface p-7">
                ...
                <p className="mt-2 text-base leading-relaxed text-slate">{p.desc}</p>
              </div>
            ))}
          </div>
          <div className="mt-8">
          ...
          <div className="mt-10 grid gap-6 text-left sm:grid-cols-4">
            {PROCESS.map((s) => (
              <div key={s.n} className="glow-card rounded-lg bg-surface p-6">
                ...
                <p className="mt-2 text-base leading-relaxed text-slate">{s.desc}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid gap-5 sm:grid-cols-3">
            {AUDIENCE.map((a) => (
              <div key={a.title} className="glow-card rounded-lg bg-surface p-7">
                ...
                <p className="mt-2 text-base leading-relaxed text-slate">{a.desc}</p>
              </div>
            ))}
          </div>
        </div>
